...
public class UpdateAnswer {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UpdateAnswer window = new UpdateAnswer(new JButton(), new JButton(), new JPanel());
	 ...
	 */
	public UpdateAnswer(JButton homeButton, JButton closeButton, JPanel borderPanel) {
	...
	private void initialize(JButton homeButton, JButton closeButton, JPanel borderPanel) {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    if (response.getString("check").equals("true")) {
                        ...
                        Message ms = new Message("답변을 수정하였습니다!");
                    } else {
                        Message ms = new Message("답변 수정에 실패했습니다.");
                    }
        ...
        btnNewButton.setBounds(88, 385, 95, 23);
        ...
        btnNewButton_1.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    data.put("checks", "NULL"); // 형식화된 시간을 JSON에 추가
                    ...
                    if (response.getString("check").equals("true")) {
                        ...
                        QnaPanel fa = new QnaPanel(borderPanel, homeButton, closeButton);
                        switchPanel(fa, borderPanel, homeButton, closeButton);
                        Message ms = new Message("답변을 삭제하였습니다!");
                    } else {
                        Message ms = new Message("답변 삭제에 실패했습니다.");
                    }
                } catch (JSONException e1) {
                    e1.printStackTrace(); // 예외 스택 트레이스 출력
                }
        ...
        btnNewButton_1.setBounds(232, 385, 95, 23);
