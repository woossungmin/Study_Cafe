...
public class UpdateLock {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UpdateLock window = new UpdateLock("","",new JFrame());
	 ...
	 */
	public UpdateLock(String lock, String lock_number,JFrame frame1) {
	...
	private void initialize(String lock, String lock_number, JFrame frame1) {
	   ...
	   JLabel lblNewLabel_1_1_1_1 = new JLabel("사물함을 변경하시겠습니까?");
	   ...
	   okbutton.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		        ...
		        try {
		            ...
		            JSONObject check = po.jsonpost("/FindLockPhone", data);
		            originlock = check.getString("lock_number");
	   ...
	   JLabel lblNewLabel_1_1_1_1_1 = new JLabel("사물함 변경이 완료되었습니다!");
