...
public class LockDeactivation {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LockDeactivation window = new LockDeactivation("","",new JPanel(),new JButton(),new JButton());
	 ...
	 */
	public LockDeactivation(String lock,String lock_number,JPanel borderpanel, JButton homebutton, JButton closebutton) {
	...
	private void initialize(String lock, String lock_number,JPanel borderpanel, JButton homebutton, JButton closebutton ) {
		...
		locklabel_2.setText("비활성화를 원하시면 확인 버튼을 눌러주세요.");
		...
		JLabel text_1 = new JLabel("비활성화가 완료되었습니다!");
