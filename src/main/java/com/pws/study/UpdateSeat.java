...
public class UpdateSeat {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UpdateSeat window = new UpdateSeat("","",new JFrame());
	 ...
	 */
	public UpdateSeat(String seat, String seat_number,JFrame frame1) {
		initialize(seat,seat_number,frame1);
	}

	/**
	 * Initialize the contents of the frame.
	 */
	private void initialize(String seat, String seat_number,JFrame frame1) {
		frame = new JFrame();
	   ...
	   JLabel lblNewLabel_1_1_1 = new JLabel("좌 석 사 용 기 한  : ");
	   ...
	   JLabel lblNewLabel_1_1_1_1 = new JLabel(" 좌석을 변경하시겠습니까?");
	   ...
	   okbutton.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		        ...
		        try {
		            ...
		            JSONObject check = po.jsonpost("/FindSeatPhone", data);
		            originSeat= check.getString("seat_number");
	            ...
	            try {
			        data.put("phone", "NULL");
					data.put("seatnumber", originSeat);
		        ...
		        try {
		            Info.seat_number = seat_number;
		            data.put("phone", Info.phone);
		            data.put("seatnumber", seat_number);
	   ...
	   JLabel lblNewLabel_1_1_1_1_1 = new JLabel(" 좌석 변경이 완료되었습니다!");
	   ...
	   lblNewLabel_2.setIcon(new ImageIcon("C:\\Users\\user\\Desktop\\Study Cafe이미지 파일\\ezgif.com-resize.gif"));
