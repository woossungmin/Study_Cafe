	...
	public Seatpanel(JPanel borderpanel, JButton homebutton, JButton closebutton) {
		...
		panel_1_1.setBackground(new Color(255,255,255));
	      ...
	      RoundedButton s1 = new RoundedButton("1" + "<br>" +"1인석");
			...
			add(lblNewLabel_1);
			JLabel lblNewLabel_4_2 = new JLabel("CAFE     ZONE");
			lblNewLabel_4_2.setForeground(new Color(114, 166, 255));
			lblNewLabel_4_2.setFont(new Font("굴림", Font.BOLD, 20));
			lblNewLabel_4_2.setBounds(651, 8, 153, 24);
			add(lblNewLabel_4_2);
			JLabel CafeZone = new JLabel("28");
			CafeZone.setForeground(new Color(255, 128, 128));
			CafeZone.setFont(new Font("굴림", Font.PLAIN, 30));
			CafeZone.setBounds(668, 22, 53, 48);
			add(CafeZone);
			CafeZone.setText(countStr3);
			...
			lblNewLabel_4_3.setBounds(436, 8, 153, 24);
			add(lblNewLabel_4_3);
